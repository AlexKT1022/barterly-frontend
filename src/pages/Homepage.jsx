    ...
    <>
      <section className="">
        <div className="flex flex-col justify-center items-center h-200">
          ...
          <Link to="">
            <button className="px-4 h-10 rounded-md bg-zinc-800 text-white hover:bg-zinc-500 transition-colors duration-300  shadow-sm mb-5">
              Get Started
            </button>
          </Link>
          <div className="mb-10">
          ...
          <div className="grid xs:grid-cols-2 grid-cols-4 gap-15">
            <Link
              to=""
