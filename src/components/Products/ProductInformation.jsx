    ...
    <div className='w-full lg:w-1/2 space-y-6'>
      <div>
        ...
        <div className='flex gap-2 mt-2 text-sm'>
          <label className='bg-gray-200 px-2 py-1 rounded'>
            {product.category}
          </label>
          <label className='bg-green-100 text-green-700 px-2 py-1 rounded'>
            {product.condition}
          </label>
          <label className='bg-blue-100 text-blue-700 px-2 py-1 rounded'>
            {product.status}
          </label>
        </div>
      </div>
