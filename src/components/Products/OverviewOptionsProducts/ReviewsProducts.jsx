  ...
  const reviewData = [
    {
      ...
      rating: 5,
      timeAgo: '2 weeks ago',
      comment: 'Amazing seller! Phone was exactly as described and shipped super fast.'
    },
    {
      name: 'Emma Davis',
      rating: 3,
      timeAgo: '1 month ago',
      comment: 'Great communication and the item was in perfect condition. Highly recommend!'
    }
  ];

  return (
    <div className="p-6 md:p-8 bg-gray-50 mb-6">
      <h2 className="text-2xl font-semibold mb-6">Reviews ({reviewData.length})</h2>
